...
def spanish1():
  ...
  writer.write("1.", font=question_font)
  writer.goto(que_pos2)
  writer.write("2.", font=question_font)
  writer.goto(que_pos3)
  writer.write("3.", font=question_font)
  writer.goto(que_pos4)
  writer.write("4.", font=question_font)
  #
  writer.write("4.", font=question_font)
...
def spanish2():
  ...
  elif answer == "2" or answer == "Cama" or answer == "cama":
    print("You got it right!")
    writer.clear()#removes overlap from last written font.
